...
const Discover = () => {
  ...
  const activeTopicStyle =
    "xl:border-2 xl:border-[#F51997] hover:bg-primary xl:border-gray-300 px-3 py-2 rounded xl:rounded-full flex items-center gap-2 justify-center cursor-pointer text-[#F51997] ";
